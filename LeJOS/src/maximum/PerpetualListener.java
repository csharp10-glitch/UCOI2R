...
public class PerpetualListener implements MoveListener {
	...
	public void moveStopped(Move move, MoveProvider mp) {
		LCD.drawString("Moved " + (int)move.getDistanceTraveled() + " cm  ", 0, 4);
	}
}
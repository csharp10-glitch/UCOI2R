...
public class MapTest{
   ...
   public static void main(String[] args){
      ...
      //TODO: put conditional to intake A star algo grid coordinates and initiliaze map with that, otherwise intialize with 0
      ...
      MovePilot pilot = new MovePilot(chassis);
       ...
       float distanceValue = 0;
       	int index = 0;
        while(index<10){	//TODO: change the while loop to conditional that robot keeps running until it reaches end goal point

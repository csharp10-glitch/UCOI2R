...
public class Controller {
	...
	static int[][] grid = new int[5][4]; //TODO 23 width x 28 length
  ...
  static final int OPEN = 0;
	...
	static final int MOVEAMOUNT=30;
	static final double MAXDISTANCE = .3;
...
//		
		...
		int index = 0;
		int searchIndex=0;
		int[] searchTargetX = new int[]{0,1,2,3};
		int[] searchTargetY = new int[]{0,4,0,4};
